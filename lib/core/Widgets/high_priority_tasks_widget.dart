...
class HighPriorityTasksWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final List<TaskModel> taskPriority = allTasks.where((task)=>task.isHighPriority).toList().reversed.toList();
              ...
              child: Column(
                ...
                children: [
                  ...
                  (taskPriority.isNotEmpty)
                    ...
                    shrinkWrap: true,
                    itemCount: (taskPriority.length > 4) ? 4 : taskPriority
                        .length,
                        ...
                        children: [
                          CustomCheckBox(
                            ...
                            onChanged: (bool? value) {
                              int indexOfAllTask = allTasks.indexWhere(
                                      (task) =>
                                  task.id == taskPriority[index].id);
                              onTap(value, indexOfAllTask);
                            },
                          ),
                          Expanded(
                            child: Column(
